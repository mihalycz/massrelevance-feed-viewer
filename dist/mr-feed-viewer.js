...
var MassRevFeedViewerModule = (function () {
    ...
    var FeedsApiService = (function () {
        function FeedsApiService(url, itemsToGet, respnseHandler) {
            _classCallCheck(this, FeedsApiService);
        ...
        _createClass(FeedsApiService, [{
            key: 'getData',
            value: function getData(sinceId) {
                var _this = this;
                ...
                var getDataPromise = new Promise(function (resolve, reject) {
                    $.ajax({
                        ...
                        success: function success(response) {
                            if (_this.responseHandler && typeof _this.responseHandler.handle === "function") {
                                resolve(_this.responseHandler.handle(response));
                            } else {
                                resolve(response);
                            }
                        },
    ...
    var FeedsResponseHandler = (function () {
        ...
        _createClass(FeedsResponseHandler, null, [{
            key: 'handle',
            value: function handle(feeds) {
                var result = [];
    ...
    var FeedsDataService = (function () {
        function FeedsDataService(url, itemsToGet, pollingInterval) {
            _classCallCheck(this, FeedsDataService);
        ...
        _createClass(FeedsDataService, [{
            ...
            value: function getData() {
                ...
                this.feedsApiService.getData(this.lastEntityId).then(function (feeds) {
                    if (feeds && feeds.length) {
                        if (_this2.resultCallback && typeof _this2.resultCallback === 'function') {
                            _this2.resultCallback(feeds);
                        }
                        _this2.lastEntityId = feeds[0].id;
                    }
                    setTimeout(_this2.getData.bind(_this2), _this2.interval);
                }, function (error) {
                    console.log(error);
                    setTimeout(_this2.getData.bind(_this2), _this2.interval);
                });
    ...
    var MassRevFeedViewer = (function () {
        function MassRevFeedViewer() {
            _classCallCheck(this, MassRevFeedViewer);
        ...
        _createClass(MassRevFeedViewer, null, [{
            key: 'getInstance',
